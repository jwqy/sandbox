		...
		gameState.attackButton.on('pointerup', () => {
			...
			if (game.input.enabled) {
				...
				if (randomMove === 0) {
					...
					gameState.information.text = 'Both player and enemy lost 1HP!';
					...
					gameState.playerHealthBar.text = `HP: ${gameState.player.health}`;
					gameState.computerHealthBar.text = `HP: ${gameState.computer.health}`;
					gameState.information.text = 'Enemy lost 1HP!';
					...
					gameState.playerHealthBar.text = `HP: ${gameState.player.health}`;
					gameState.computerHealthBar.text = `HP: ${gameState.computer.health}`;
					gameState.information.text = 'Enemy lost 5HP!';
		...
		gameState.defendButton.on('pointerup', () => {
			...
			if (game.input.enabled) {
				...
				if (randomMove === 0) {
					...
					gameState.playerHealthBar.text = `HP: ${gameState.player.health}`;
					gameState.computerHealthBar.text = `HP: ${gameState.computer.health}`;
					gameState.information.text = 'No HP lost!';
					...
					gameState.playerHealthBar.text = `HP: ${gameState.player.health}`;
					gameState.computerHealthBar.text = `HP: ${gameState.computer.health}`;
					gameState.information.text = 'Player lost 4HP';
